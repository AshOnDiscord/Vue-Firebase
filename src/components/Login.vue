      ...
      <div class="bg-white py-8 px-4 shadow sm:rounded-lg sm:px-10">
        <form class="space-y-6" @submit.prevent="signIn">
          ...
          <div
            ...
            v-if="responseObj.loggedIn == false"
          >
            <div class="flex">
        ...
        <p class="text-gray-500 text-sm text-center mt-4">
          No Account? <span class="text-slate-700">Get Whitelisted.</span>
        </p>
        <!-- <div class="mt-6">
          <div class="relative">
  ...
  methods: {
    async signIn() {
      try {
        ...
        if (this.responseObj.loggedIn) {
          this.$emit("response", {
            UID: this.responseObj.UID,
            Username: this.responseObj.Username,
          });
          if (this.stayLogged) {
            localStorage.setItem("UID", this.responseObj.UID);
